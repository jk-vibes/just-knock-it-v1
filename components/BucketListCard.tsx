      ...
      switch (theme) {
          case 'marvel':
              return {
                  ...
                  tagPill: 'bg-red-50 text-red-600 border-red-100 hover:bg-red-100',
                  interestPill: 'text-slate-500 bg-slate-50 border-slate-100 hover:bg-slate-100',
                  icon: 'text-blue-500',
                  shareBtn: 'text-blue-400 bg-blue-50 hover:bg-blue-100 hover:scale-110',
